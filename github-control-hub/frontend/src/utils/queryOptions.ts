...
export const QUERY_OPTIONS = [
  { id: "repos-dependent-on", entity: "repository", informational: true, label: "Repos exposed through vulnerable package(s)...", requiresParam: true, paramLabel: "Package name(s)", icon: "ph-package", useTagInput: true, hasDependabotScope: true },
