                      ...
                      <div className="flex items-start border-t border-gray-100 pt-3">
                        ...
                        {rule.protection && (
                          <div className="flex-1 min-w-0 pl-4 border-l border-gray-100 space-y-3">
                            <div className="flex items-center justify-between bg-gray-50 p-1.5 rounded-md border border-gray-200/60 mb-3 w-full">
                              {!rule.jsonMode ? (
                                ...
                                <div className="px-3 py-1 text-[11px] font-semibold text-gh-muted">
                            ...
                            {rule.jsonMode ? (
                              <div className="flex flex-col gap-2">
                                <textarea
                                  ...
                                  onChange={(e) => updateJsonString(idx, e.target.value)}
                                  className={`w-full h-64 p-3 text-[13px] font-mono border rounded-md focus:ring-2 focus:outline-none bg-gray-50 text-gray-800 ${rule.jsonError ? 'border-red-400 focus:border-red-500 focus:ring-red-200' : 'border-gray-300 focus:border-gh-blue focus:ring-blue-100'}`}
                                  spellCheck={false}
                                />
                                {rule.jsonError && (
