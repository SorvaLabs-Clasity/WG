...
export default function BranchRow({
  ...
  return (
    <tr className="table-row-hover transition-colors group">
      ...
      <td className="py-3.5 px-5">
        {branch.protected ? (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5  text-xs font-medium border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950/50 text-green-700 dark:text-green-400 shadow-sm">
            <i className="ph-fill ph-shield-check text-green-600"></i> Protected
          </span>
        ) : (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5  text-xs font-medium border border-gray-200 dark:border-rule bg-white dark:bg-paper text-gray-600 dark:text-slate-400 shadow-sm">
            Unprotected
          </span>
        )}
      </td>
